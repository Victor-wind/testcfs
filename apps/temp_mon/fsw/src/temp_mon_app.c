...
** Author(s):  Jane Smith 
**
** History:  Date Written  2018-07-03
...
int32 TEMP_MON_InitPipe()
{
    ...
    if (iStatus == CFE_SUCCESS)
    {
        CFE_SB_Subscribe(TEMP_IO_OUT_DATA_MID, g_TEMP_MON_AppData.TlmPipeId);
    }
    else
    {
...
int32 TEMP_MON_InitData()
{
    ...
    g_TEMP_MON_AppData.iTempVal     = 0;
    g_TEMP_MON_AppData.iPrevTempVal = 0;
    g_TEMP_MON_AppData.iColdLimit   = 45;
    g_TEMP_MON_AppData.iHotLimit    = 85;
    g_TEMP_MON_AppData.sDirection   = TEMP_NOCHANGE;
    g_TEMP_MON_AppData.sRange       = TEMP_NOMINAL;
...
void TEMP_MON_ProcessNewData()
{
    ...
    TEMP_IO_OutData_t* dataPtr=NULL;
    ...
    while (1)
    {
        ...
        if (iStatus == CFE_SUCCESS)
        {
            ...
            switch (TlmMsgId)
            {
                case TEMP_IO_OUT_DATA_MID:
                    /* Update temperature value */
                    dataPtr = (TEMP_IO_OutData_t *)TlmMsgPtr;
                    g_TEMP_MON_AppData.iPrevTempVal = g_TEMP_MON_AppData.iTempVal;
                    g_TEMP_MON_AppData.iTempVal = dataPtr->iTempValue;

                    /* Determine if it's increasing, decreasing or no change*/
                    g_TEMP_MON_AppData.sDirection = TEMP_NOCHANGE;
                    if (g_TEMP_MON_AppData.iTempVal > g_TEMP_MON_AppData.iPrevTempVal)
                    {
                        g_TEMP_MON_AppData.sDirection = TEMP_INCREASING;
                    }
                    else if (g_TEMP_MON_AppData.iTempVal < g_TEMP_MON_AppData.iPrevTempVal)
                    {
                        g_TEMP_MON_AppData.sDirection = TEMP_DECREASING;
                    }

                    /* Determine its range */
                    g_TEMP_MON_AppData.sRange = TEMP_NOMINAL;
                    if (g_TEMP_MON_AppData.iTempVal >= g_TEMP_MON_AppData.iHotLimit)
                    {
                        g_TEMP_MON_AppData.sRange = TEMP_HOT;
                    }
                    else if (g_TEMP_MON_AppData.iTempVal <= g_TEMP_MON_AppData.iColdLimit)
                    {
                        g_TEMP_MON_AppData.sRange = TEMP_COLD;
                    }
                    break;
...
{
    uint32  uiCmdCode=0;
    TEMP_MON_IntArgCmd_t* cmdPtr=NULL;
    ...
    if (MsgPtr != NULL)
    {
        ...
        switch (uiCmdCode)
        {
            ...
            case TEMP_MON_SET_COLD_LIMIT_CC:
                cmdPtr = (TEMP_MON_IntArgCmd_t *)MsgPtr;
                g_TEMP_MON_AppData.iColdLimit = cmdPtr->iValue;
                g_TEMP_MON_AppData.HkTlm.usCmdCnt++;
                CFE_EVS_SendEvent(TEMP_MON_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_MON - Recvd SET_COLD_LIMIT cmd (%d) - %d",
                                  (int)uiCmdCode, (int)g_TEMP_MON_AppData.iColdLimit);
                break;

            case TEMP_MON_SET_HOT_LIMIT_CC:
                cmdPtr = (TEMP_MON_IntArgCmd_t *)MsgPtr;
                g_TEMP_MON_AppData.iHotLimit = cmdPtr->iValue;
                g_TEMP_MON_AppData.HkTlm.usCmdCnt++;
                CFE_EVS_SendEvent(TEMP_MON_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_MON - Recvd SET_HOT_LIMIT cmd (%d) - %d",
                                  (int)uiCmdCode, (int)g_TEMP_MON_AppData.iHotLimit);
                break;
...
{
    g_TEMP_MON_AppData.HkTlm.iTempValue     = g_TEMP_MON_AppData.iTempVal;
    g_TEMP_MON_AppData.HkTlm.sTempDirection = g_TEMP_MON_AppData.sDirection;
    g_TEMP_MON_AppData.HkTlm.sTempRange     = g_TEMP_MON_AppData.sRange;

    CFE_SB_TimeStampMsg((CFE_SB_Msg_t*)&g_TEMP_MON_AppData.HkTlm);
    CFE_SB_SendMsg((CFE_SB_Msg_t*)&g_TEMP_MON_AppData.HkTlm);

    CFE_EVS_SendEvent(TEMP_MON_INF_EID, CFE_EVS_INFORMATION,
                      "TEMP_MON - HkTlm - Temp=%d, Dir=%d, Range=%d",
                      (int)g_TEMP_MON_AppData.HkTlm.iTempValue,
                      (int)g_TEMP_MON_AppData.HkTlm.sTempDirection,
                      (int)g_TEMP_MON_AppData.HkTlm.sTempRange);
}
