...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
  ...
  */
    /* command ID #30 - Command Ingest (CI) HK Request */
  { { CFE_MAKE_BIG16(CI_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #31 - Telemetry Output (TO) HK Request */
  { { CFE_MAKE_BIG16(TO_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #32 - Command Ingest (CI) Wakeup Command */
  { { CFE_MAKE_BIG16(CI_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #33 - Telemetry Output (TO) Wakeup Command*/
  { { CFE_MAKE_BIG16(TO_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },

    /* command ID #34 */
  { { CFE_MAKE_BIG16(TEMP_IO_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #35 */
  { { CFE_MAKE_BIG16(TEMP_MON_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #36 */
  { { CFE_MAKE_BIG16(TEMP_IO_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #37 */
  { { CFE_MAKE_BIG16(TEMP_MON_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #38 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
    /* command ID #39 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
