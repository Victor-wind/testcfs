...
int32 TEMP_IO_InitData()
{
    ...
    g_TEMP_IO_AppData.iCurTempVal = 0;
    g_TEMP_IO_AppData.iDeltaVal = 1;
...
{
    g_TEMP_IO_AppData.iCurTempVal += g_TEMP_IO_AppData.iDeltaVal;
}
...
{
    uint32  uiCmdCode=0;
    TEMP_IO_IntArgCmd_t* cmdPtr=NULL;
    ...
    if (MsgPtr != NULL)
    {
        ...
        switch (uiCmdCode)
        {
            ...
            case TEMP_IO_SET_CURRENT_TEMP_CC:
                cmdPtr = (TEMP_IO_IntArgCmd_t *)MsgPtr;
                g_TEMP_IO_AppData.iCurTempVal = cmdPtr->iValue;
                g_TEMP_IO_AppData.HkTlm.usCmdCnt++;
                CFE_EVS_SendEvent(TEMP_IO_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_IO - Recvd SET_CURRENT_TEMP cmd (%d) - %d",
                                  (int)uiCmdCode, (int)g_TEMP_IO_AppData.iCurTempVal);
                break;

            case TEMP_IO_SET_DELTA_VALUE_CC:
                cmdPtr = (TEMP_IO_IntArgCmd_t *)MsgPtr;
                g_TEMP_IO_AppData.iDeltaVal = cmdPtr->iValue;
                g_TEMP_IO_AppData.HkTlm.usCmdCnt++;
                CFE_EVS_SendEvent(TEMP_IO_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_IO - Recvd SET_DELTA_VALUE cmd (%d) - %d", 
                                  (int)uiCmdCode, (int)g_TEMP_IO_AppData.iDeltaVal);
                break;
...
{
    g_TEMP_IO_AppData.OutData.iTempValue = g_TEMP_IO_AppData.iCurTempVal;
